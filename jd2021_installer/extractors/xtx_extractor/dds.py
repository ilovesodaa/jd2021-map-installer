...
# Copyright (c) 2016-2017 Stella/AboodXD
    ...
    if compressed:
        ...
        if luminance:
            ...
            if has_alpha:
                ...
                if channel0 in bgr8_masks and channel1 in bgr8_masks and channel2 in bgr8_masks and channel3 == 0 and bpp == 3:
                    format_ = 0x38 if SRGB else 0x25
